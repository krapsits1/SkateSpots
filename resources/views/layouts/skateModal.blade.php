    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="skateSpotModalLabel">Skate Spot Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="mb-0" id="modalTitle">Title</h5>
                    <p class="mb-0" id="modalDate">Date</p>
                </div>
                ...
                <p  class = "" id="modalDescription">Description</p>
                <h5>Location</h5>
                <div class="d-flex align-items-center border rounded">
                    <span class="p-2" id="modalLatitude">Latitude</span>, <span id="modalLongitude">Longitude</span>
                    <button type="button" onclick="copyCoordinatesToClipboard()" class="btn btn-primary p-2 ms-auto">
